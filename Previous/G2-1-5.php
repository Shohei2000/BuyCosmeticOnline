	...
	<div class="container">
		<div class="row">
			...
			<div class="col-2 bg-secondary p-0 justify-content:flex-start; align-items:center;" style="min-height:356.953px;">
				<a href="" class="text-white bg-dark p-3 mb-1" style="text-align: center;">検索履歴画面</a>
			...
			<div class="col-10">
				...
				<input class="button" type="button" onclick="location.href='G2-1-1.php'" value="会員情報へ戻る">
			</div>
		</div>
	</div>

...
<div class="main-container">
	<div class="row">
		<div class="col-sm-12" style="margin:2vw 0;">
			<p class="font-size25" style="font-weight:bold;">商品編集完了</p>
		</div>
	</div>

	<div class="row">
		<div class="col-sm-12" style="text-align:center;">
			<p class="font-size2">編集が完了しました</p>
			<p class="font-size15">出品内容に問題がないか出品リストからご確認ください</p>
		</div>
	</div>

	<div class="row">
		<div class="col-sm-12 button_container" style="display:flex; justify-content:center; align-items:center;">
